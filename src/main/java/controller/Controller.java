...
protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	System.out.println("무어미");
//	System.out.println(" 파라미터값아 들어와라 : "+request.getParameter("boardnum"));
	...
	*/
	...
	if(urls.length<2) {
		...
		System.out.println("index들어옴");
			...
			List<TotalBoard>list = bd.getTotallist();			
		...
		//인덱스에서의 웹 url은 실질적으로 /WEB-INF/board/section.jsp
			...
			page+="board.jsp";			
			BoardsDAO bd =new BoardsDAO();			
			TotalBoard totalboard = bd.getTotalboard(request.getParameter("boardnum"));			
			request.setAttribute("boards",totalboard);
