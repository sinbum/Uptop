            ...
            <div class="row">
              <div class="col-sm-8" style="background-color:white;">
                    <ul class="row">
                        ...
                        <li class="col-sm-12">
                            <ul >
                                <li id="board_name">${board.get(0).getBoards_name()}</li><hr>
                            </ul> 
                        </li>                    
                        ...
                        <li class="col-sm-12">
                            ...
                            <hr>
                            <div>
                            	<jsp:include page="/WEB-INF/board/reply/replies.jsp"></jsp:include>
                            </div>
                ...
                <div id="main_aside" class="col-sm-4" style="background-color:orange;">
                     <p>              
                    <jsp:include page="/WEB-INF/view/section.jsp"></jsp:include>
                </div>
            </div>
            </div>
